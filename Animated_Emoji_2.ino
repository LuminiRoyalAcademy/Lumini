 ...
 *
 * This version adds four new emoji animations.
 */
...
// ---
// --- NEW: IMPROVED ANIMATION FUNCTIONS ---
// ---

void playWinkAnimation() {
  // We'll use a large text size to fill the screen
  int y = 20; // Centered Y
  ...
  for (int i = 0; i < 4; i++) {
    ...
    display.clearDisplay();
    display.setTextSize(3);
    display.setCursor(33, y); // Centered X for "(- -)"
    display.print("(- -)");
    display.display();
    delay(200);
  }
...
void playHeartAnimation() {
  // This function draws a "beating" heart using shapes
  // Play the animation 4 times
  for (int i = 0; i < 4; i++) {
    // --- Frame 1: Small Heart ---
    display.clearDisplay();
...
void initializeMorseMap() {
    ...
    morseMap["...--"] = "3"; morseMap["....-"] = "44"; morseMap["....."] = "5";
